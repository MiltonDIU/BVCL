...
@section('content')
    @can('training_apply_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.training-applies.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.trainingApply.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-TrainingApply">
                    <thead>
                    <tr>
                        <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-TrainingApply:not(.ajaxTable)').DataTable({ buttons: dtButtons })
