...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userBusinesses">
                <thead>
                <tr>
                    <th width="10">
...
{{--                pageLength: 100,--}}
{{--            });--}}
{{--            let table = $('.datatable-userBusinesses:not(.ajaxTable)').DataTable({ buttons: dtButtons })--}}
