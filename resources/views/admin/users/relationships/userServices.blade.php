...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userServices">
                <thead>
                <tr>
                    <th width="10">
...
{{--                pageLength: 100,--}}
{{--            });--}}
{{--            let table = $('.datatable-userServices:not(.ajaxTable)').DataTable({ buttons: dtButtons })--}}
