...
@section('content')
    @can('service_history_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.service-histories.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.serviceHistory.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ServiceHistory">
                <thead>
                <tr>
                    <th width="10">
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                    ...
                    retrieve: true,
                    aaSorting: [],
                    ajax: "{{ route('admin.service-histories.index') }}",
                    columns: [
            ...
            let table = $('.datatable-ServiceHistory').DataTable(dtOverrideGlobals);
