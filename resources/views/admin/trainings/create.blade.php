    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.trainings.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="start_date">{{ trans('cruds.training.fields.end_date') }}</label>
                        ...
                        <div class="col-lg-12">
                            <div id="inputFormRow">
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control m-input timepicker {{ $errors->has('begin_time') ? 'is-invalid' : '' }} col-md-4" type="text" name="begin_time[]" id="begin_time" value="{{ old('begin_time') }}" required>
                                    <input class="form-control m-input timepicker {{ $errors->has('close_time') ? 'is-invalid' : '' }} col-md-4" type="text" name="close_time[]" id="close_time" value="{{ old('close_time') }}">
