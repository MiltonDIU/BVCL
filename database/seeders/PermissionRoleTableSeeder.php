...
class PermissionRoleTableSeeder extends Seeder
{
    public function run()
    {
        ...
        Role::findOrFail(4)->permissions()->sync($teacher_permissions);

        $user_permissions = $admin_permissions->whereIn('title', [
        ...
        Role::findOrFail(3)->permissions()->sync($special_permissions);
    }
}
